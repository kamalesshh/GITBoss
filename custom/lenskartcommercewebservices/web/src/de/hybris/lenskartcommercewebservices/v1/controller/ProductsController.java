 ...
 */
package de.hybris.lenskartcommercewebservices.v1.controller;

import static de.hybris.lenskartcommercewebservices.constants.YcommercewebservicesConstants.ENUM_VALUES_SEPARATOR;
...
import de.hybris.lenskartcommercewebservices.formatters.WsDateFormatter;
import de.hybris.lenskartcommercewebservices.product.data.ProductDataList;
import de.hybris.lenskartcommercewebservices.product.data.SuggestionDataList;
import de.hybris.lenskartcommercewebservices.queues.data.ProductExpressUpdateElementData;
import de.hybris.lenskartcommercewebservices.queues.data.ProductExpressUpdateElementDataList;
import de.hybris.lenskartcommercewebservices.queues.impl.ProductExpressUpdateQueue;
import de.hybris.lenskartcommercewebservices.stock.CommerceStockFacade;
import de.hybris.lenskartcommercewebservices.util.ws.SearchQueryCodec;
import de.hybris.lenskartcommercewebservices.validator.PointOfServiceValidator;
...
public class ProductsController extends BaseController
{
	 ...
	 * {@link de.hybris.lenskartcommercewebservices.populator.HttpRequestReviewDataPopulator} to populate review data
