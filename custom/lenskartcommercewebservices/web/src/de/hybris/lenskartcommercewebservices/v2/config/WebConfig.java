 ...
 */
package de.hybris.lenskartcommercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import de.hybris.lenskartcommercewebservices.constants.YcommercewebservicesConstants;
import de.hybris.lenskartcommercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "lenskartcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "lenskartcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "lenskartcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "lenskartcommercewebservices.v2.description";
	private static final String TITLE = "lenskartcommercewebservices.v2.title";
	private static final String VERSION = "lenskartcommercewebservices.v2.version";
	private static final String LICENSE = "lenskartcommercewebservices.v2.license";
	private static final String LICENSE_URL = "lenskartcommercewebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "lenskartcommercewebservices.content.negotiation.legacy";
