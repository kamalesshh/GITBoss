 ...
 */
package de.hybris.newproduct.jalo;
...
import de.hybris.newproduct.constants.NewproductConstants;
 ...
 */
public class NewproductManager extends GeneratedNewproductManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(NewproductManager.class.getName());
	 ...
	 */
	public static NewproductManager getInstance()
	{
		return (NewproductManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(NewproductConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NewproductManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NewproductManager called.");
		}
	}
