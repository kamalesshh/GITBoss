 ...
 */
package de.hybris.newproductwebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import de.hybris.newproductwebservices.constants.YcommercewebservicesConstants;
import de.hybris.newproductwebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "newproductwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "newproductwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "newproductwebservices.oauth2.tokenUrl";

	private static final String DESC = "newproductwebservices.v2.description";
	private static final String TITLE = "newproductwebservices.v2.title";
	private static final String VERSION = "newproductwebservices.v2.version";
	private static final String LICENSE = "newproductwebservices.v2.license";
	private static final String LICENSE_URL = "newproductwebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "newproductwebservices.content.negotiation.legacy";
